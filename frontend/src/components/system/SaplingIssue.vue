<template>
  <v-container
    class="sapling-page-shell sapling-page-shell--panel sapling-page-shell--fill sapling-page-shell--scroll sapling-page-shell--uniform-inset sapling-issue-dashboard"
    fluid
  >
