...
export class MarketingCampaignStatusItem {
  ...
  @ApiPropertyOptional({ default: 'mdi-calendar-clock' })
  @Sapling(['isIcon'])
  @SaplingForm({
    order: 200,
    group: 'marketingCampaignStatus.groupAppearance',
    groupOrder: 200,
    width: 1,
    visible: true,
    tableOrder: 200,
  ...
  @Property({ default: 'mdi-calendar-clock', length: 64, nullable: false })
  icon?: string = 'mdi-calendar-clock';
