...
import {
  VECTOR_ENTITY_HANDLES,
  VECTOR_SEARCHABLE_SECTIONS,
  VECTOR_SEARCH_RELATIONS,
  VECTOR_SEARCH_USAGE_HINTS,
  VECTOR_SECTION_FIELD_PATHS,
  type VectorizableEntityHandle,
} from './ai-vector.config';
export {
  VECTOR_ENTITY_HANDLES,
  VECTOR_SEARCHABLE_SECTIONS,
  VECTOR_SEARCH_RELATIONS,
