...
function buildPropertyMappingPrompt(
  ...
  return [
    ...
    '4. Lade die aktiven d.velop Eigenschaften der Verbindung mit generic_list auf dvelopProperty. Filtere ueber connection.handle und isActive=true, sortiere nach title ASC und lade bis zu 200 Datensaetze.',
